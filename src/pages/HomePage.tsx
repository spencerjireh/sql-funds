    ...
    <div>
      <div className={styles.hero}>
        ...
        <div className={styles.heroMeta}>
          <span className={styles.heroBadge}>25 lessons</span>
          <span className={styles.heroBadge}>In-browser SQLite</span>
          <span className={styles.heroBadge}>Zero setup</span>
        </div>
      </div>
              ...
              {section.lessons.map((lesson) => (
                <li key={lesson.slug} className={styles.lessonItem}>
                  <Link to={`/lessons/${lesson.slug}`} className={styles.lessonLink}>
                    ...
                    <span className={styles.lessonArrow}>&rarr;</span>
                  </Link>
                </li>
              ))}
            </ul>
